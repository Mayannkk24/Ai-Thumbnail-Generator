        ...
        <>
            ...
            >
                ...
                <div className="hidden md:flex items-center gap-8 transition duration-500">
                    <Link to='/' className="hover:text-pink-400 transition">Home
                    </Link>
                     <Link to='/generate' className="hover:text-pink-400 transition">Generate
                    </Link>
                    {
                        isLoggedIn ?  <Link to='/my-generations' className="hover:text-pink-400 transition">My Generations
                    </Link>

                    : <Link to='#' className="hover:text-pink-400 transition">About
                    </Link>
                    }
                   
                    <Link to='#' className="hover:text-pink-400 transition">Contact us
                    </Link>
            ...
            <div className={`fixed inset-0 z-100 bg-black/40 backdrop-blur flex flex-col items-center justify-center text-lg gap-8 md:hidden transition-transform duration-400 ${isOpen ? "translate-x-0" : "-translate-x-full"}`}>
                ...
                {
                    isLoggedIn ? <Link onClick={() => setIsOpen(false)} to='/my-generations' >My Generations</Link>
