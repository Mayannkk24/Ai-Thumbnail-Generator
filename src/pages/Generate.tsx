...
const Generate = () => {
  ...
  const handleImprove = async () => {
    ...
    const api_payload = {
      title,
      prompt: `${additionalDetails} Improve clarity, contrast, composition and text readability.`,
      style,
      aspect_ratio: aspectRatio,
      color_scheme: colorSchemeId,
      text_overlay: true,
      parent_thumbnail_id: thumbnail._id,
    };
    ...
    try {
      ...
      if (data.thumbnail) {
        navigate("/generate/" + data.thumbnail._id);
        toast.success("Improved thumbnail generated");
      }
    } catch (error: any) {
      toast.error("Failed to improve thumbnail");
    }
  };
              ...
              <div className="p-6 rounded-2xl bg-white/8 border border-white/12 shadow-xl space-y-6">
                <div>
                  ...
                  <p className="text-sm text-zinc-400">
                    Describe your thinking, let AI bring it to life.
                  </p>
                </div>
                ...
                <div className="space-y-5">
                  ...
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 rounded-lg border border-white/12 bg-black/20 text-zinc-200 placeholder:text-zinc-400 focus:outline-none focus:ring-2 focus:ring-pink-600"
                    />
                ...
                {!id && (
                  <button
                    ...
                    disabled={loading}
                    className="text-[15px] w-full py-3.5 rounded-xl font-medium bg-linear-to-b from-pink-500 to-pink-600 hover:from-pink-700 transition-colors"
                  >
